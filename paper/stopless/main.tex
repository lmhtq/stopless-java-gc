...
\affiliation{\institution{[Anonymised]}\country{[Anonymised]}}
\email{}
...
from Claude (Anthropic) via Claude Code, under human direction and
review; the project repository's documentation records the division of
labour in detail. Per current arXiv policy the model is not an author;
assistance is declared.
