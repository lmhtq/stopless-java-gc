...
collector: relocation, revocation, healing, and identity, validated by
whole-heap-relocation integrity tests. It is not yet a complete
...
integer chain to the final address before deriving a capability. We
...
size. Part of this flatness is by construction---the workload holds roots
